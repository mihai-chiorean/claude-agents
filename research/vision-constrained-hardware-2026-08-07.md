...
**Two practical gotchas:** (1) **llama.cpp/GGUF does not do native video** for Qwen3-VL (image mode works; video is an open feature request) — true video mode means the vLLM/Transformers path, or manually feeding sampled frames as multi-image, which for a 16-frame storyboard is functionally equivalent. (2) A third-party reproduction of Cosmos-Reason2-2B's benchmark scores came in ~6 points under the official numbers — calibrate expectations on your own eval [3p].
...
**Frame selection.** [AKS — Adaptive Keyframe Sampling (CVPR 2025)](https://arxiv.org/abs/2502.21271) · [Frame Sampling Strategies Matter for small VLMs (2025)](https://arxiv.org/pdf/2509.14769) · [MDP3](https://arxiv.org/pdf/2501.02885)
